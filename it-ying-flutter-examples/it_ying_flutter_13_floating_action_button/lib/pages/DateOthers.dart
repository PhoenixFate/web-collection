...
class DateOthers extends StatefulWidget {
  DateOthers({Key key}) : super(key: key);

  @override
  _DateOthersState createState() => _DateOthersState();
}

class _DateOthersState extends State<DateOthers> {
  @override
