...
*/
var db_1 = require("./my_modules/db");
console.log(db_1.dbUrl);
console.log(db_1.getData11());
var db2_1 = require("./my_modules/db2");
console.log(db2_1.dbUrl22);
console.log(db2_1.getData22());
//使用export default 暴露的 import的时候可以名字不一样
var db3_1 = __importDefault(require("./my_modules/db3"));
console.log(db3_1.default());
